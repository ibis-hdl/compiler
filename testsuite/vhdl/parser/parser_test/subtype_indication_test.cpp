...
struct subtype_indication_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( subtype_indication,
    ...
    ^ subtype_indication_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::subtype_indication;
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::subtype_indication;
#else    
