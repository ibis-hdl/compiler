/*
 * constrained_array_definition_test.cpp
 *
...
struct constrained_array_definition_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
#else    
    auto const& parser = testsuite::vhdl_parser::constrained_array_definition();
#endif
