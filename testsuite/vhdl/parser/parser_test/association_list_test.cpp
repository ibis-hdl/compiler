...
struct association_list_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::association_list;
#else    
    auto const& parser = testsuite::vhdl_parser::association_list();
#endif
