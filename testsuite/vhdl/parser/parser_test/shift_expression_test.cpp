...
struct shift_expression_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( shift_expression,
    ...
    ^ shift_expression_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::shift_expression;
    auto const parser = parser::shift_expression;
