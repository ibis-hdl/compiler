...
struct signal_assignment_statement_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
    ...
    input, expected, test_case_name)
{
    ...
    auto const& parser = testsuite::vhdl_parser::signal_assignment_statement();
