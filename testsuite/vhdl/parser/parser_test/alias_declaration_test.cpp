...
struct alias_declaration_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
#else    
    auto const& parser = testsuite::vhdl_parser::alias_declaration();
#endif
