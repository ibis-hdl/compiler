...
struct index_constraint_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( index_constraint,
    ...
    ^ index_constraint_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::index_constraint;
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::index_constraint;
#else    
    auto const& parser = testsuite::vhdl_parser::index_constraint();
#endif
