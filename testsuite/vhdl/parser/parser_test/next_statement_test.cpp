...
struct next_statement_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( next_statement,
    ...
    ^ next_statement_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::next_statement;
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::next_statement;
#else    
    auto const& parser = testsuite::vhdl_parser::next_statement();
#endif
