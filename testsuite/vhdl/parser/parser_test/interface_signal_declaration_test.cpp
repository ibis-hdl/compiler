/*
 * interface_signal_declaration_test.cpp
 *
...
struct interface_signal_declaration_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( interface_signal_declaration,
    ...
    ^ interface_signal_declaration_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::interface_signal_declaration;
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::interface_signal_declaration;
#else    
    auto const& parser = testsuite::vhdl_parser::interface_signal_declaration();
#endif
