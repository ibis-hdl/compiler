...
struct exit_statement_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( exit_statement,
    ...
    ^ exit_statement_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::exit_statement;
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::exit_statement;
#else    
    auto const& parser = testsuite::vhdl_parser::exit_statement();
#endif
