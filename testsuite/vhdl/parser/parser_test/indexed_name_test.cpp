...
struct indexed_name_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( indexed_name,
    ...
    ^ indexed_name_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::indexed_name;
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::indexed_name;
#else    
    auto const& parser = testsuite::vhdl_parser::indexed_name();
#endif
