...
struct qualified_expression_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::qualified_expression;
#else    
    auto const& parser = testsuite::vhdl_parser::qualified_expression();
#endif
