/*
 * primary_unit_declaration_test.cpp
 *
...
struct primary_unit_declaration_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
#else    
    auto const& parser = testsuite::vhdl_parser::primary_unit_declaration();
#endif
