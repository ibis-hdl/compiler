...
struct attribute_name_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( attribute_name,
    ...
    ^ attribute_name_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::attribute_name;
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::attribute_name;
#else    
    auto const& parser = testsuite::vhdl_parser::attribute_name();
#endif
