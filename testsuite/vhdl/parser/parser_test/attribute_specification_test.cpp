...
struct attribute_specification_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::attribute_specification;
#else    
    auto const& parser = testsuite::vhdl_parser::attribute_specification();
#endif
