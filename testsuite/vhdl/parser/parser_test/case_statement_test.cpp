...
struct case_statement_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( case_statement,
    ...
    ^ case_statement_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::case_statement;
    auto const& parser = testsuite::vhdl_parser::case_statement();
