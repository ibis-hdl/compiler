...
struct procedure_call_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
#else    
    auto const& parser = testsuite::vhdl_parser::procedure_call();
#endif
