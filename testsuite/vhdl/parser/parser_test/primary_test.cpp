...
struct primary_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
    primary_dataset()
...
BOOST_DATA_TEST_CASE( primary,
    ...
    ^ primary_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::primary;
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::primary;
#else    
    auto const& parser = testsuite::vhdl_parser::primary();
#endif
