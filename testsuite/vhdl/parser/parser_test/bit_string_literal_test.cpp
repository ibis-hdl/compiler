...
struct bit_string_literal_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
BOOST_DATA_TEST_CASE( bit_string_literal,
    ...
    ^ bit_string_literal_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::bit_string_literal;
    auto const& parser = testsuite::vhdl_parser::bit_string_literal();
