...
struct character_literal_dataset : public testsuite::vhdl_parser::util::dataset_loader
{
...
#if defined(NO_BOOST_SPIRIT_INSTANCES)
    auto const parser = parser::character_literal;
#else    
    auto const& parser = testsuite::vhdl_parser::character_literal();
#endif
