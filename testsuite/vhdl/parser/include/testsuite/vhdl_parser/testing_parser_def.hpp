/*
 * testing_parser_def.hpp
 *
 *  Created on: 04.05.2018
 *      Author: olpetzol
 */

#ifndef SOURCES_VHDL_TEST_INCLUDE_TESTSUITE_VHDL_PARSER_TESTING_PARSER_DEF_HPP_
#define SOURCES_VHDL_TEST_INCLUDE_TESTSUITE_VHDL_PARSER_TESTING_PARSER_DEF_HPP_
...
std::tuple<bool, std::string> testing_parser<AttrType>::operator()(
