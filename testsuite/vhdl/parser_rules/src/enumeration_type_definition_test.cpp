...
BOOST_DATA_TEST_CASE_F( testsuite::failure_diagnostic_fixture,
    ...
    utf_data::make_delayed<testsuite::dataset_loader>( "test_case/enumeration_type_definition" ),
    input, expected, test_case_name)
{
    using attribute_type = ast::enumeration_type_definition; 
    auto const& parser = testsuite::vhdl_parser::enumeration_type_definition();
