...
BOOST_DATA_TEST_CASE_F(  // --
    testsuite::vhdl_parser::util::failure_diagnostic_fixture, physical_literal,
    utf_data::make_delayed<testsuite::dataset_loader>("test_data/physical_literal"),  // --
...
BOOST_DATA_TEST_CASE_F(  // --
    ...
    utf_data::make_delayed<testsuite::dataset_loader>("test_data/physical_literal_failure"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::physical_literal;
    auto const& parser = testsuite::vhdl_parser::physical_literal();
