...
BOOST_DATA_TEST_CASE_F(  // --
    ...
    utf_data::make_delayed<testsuite::util::dataset_loader>("test_data/identifier"),  // --
...
BOOST_DATA_TEST_CASE_F(  // --
    ...
    utf_data::make_delayed<testsuite::util::dataset_loader>("test_data/identifier_failure"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::identifier;
    auto const& parser = testsuite::vhdl_parser::identifier();
