...
BOOST_DATA_TEST_CASE( generate_statement,
      generate_statement_dataset.input()
    ^ generate_statement_dataset.expect()
    ^ generate_statement_dataset.test_case_name(),
    input, expected, test_case_name)
{
    using attribute_type = ast::generate_statement; 
    auto const& parser = testsuite::vhdl_parser::generate_statement();
