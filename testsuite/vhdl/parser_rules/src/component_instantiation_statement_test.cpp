...
BOOST_DATA_TEST_CASE_F(  // --
    testsuite::vhdl_parser::util::failure_diagnostic_fixture, component_instantiation_statement,
    utf_data::make_delayed<testsuite::util::dataset_loader>("test_data/component_instantiation_statement"),  // --
