...
BOOST_DATA_TEST_CASE_F(  // --
    testsuite::vhdl_parser::util::failure_diagnostic_fixture, simple_expression,
    utf_data::make_delayed<testsuite::util::dataset_loader>("test_data/simple_expression"),  // --
