//
// @file return_statement_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    return_statement,                                                              // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("return_statement"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::return_statement;
    auto const parser = testsuite::vhdl::parser::return_statement();
