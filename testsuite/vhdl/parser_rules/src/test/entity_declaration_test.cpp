//
// @file entity_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(entity_declaration, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("entity_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::entity_declaration;
    auto const parser = testsuite::vhdl::parser::entity_declaration();
