//
// @file component_instantiation_statement_test.cpp
//
...
BOOST_DATA_TEST_CASE(component_instantiation_statement, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("component_instantiation_statement"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::component_instantiation_statement;
    auto const parser = testsuite::vhdl::parser::component_instantiation_statement();
