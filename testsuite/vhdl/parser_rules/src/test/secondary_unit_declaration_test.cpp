//
// @file secondary_unit_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    ...
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("secondary_unit_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::secondary_unit_declaration;
    auto const parser = testsuite::vhdl::parser::secondary_unit_declaration();
