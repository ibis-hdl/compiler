//
// @file component_specification_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    ...
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("component_specification"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::component_specification;
    auto const parser = testsuite::vhdl::parser::component_specification();
