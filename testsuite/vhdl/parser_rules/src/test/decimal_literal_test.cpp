...
BOOST_DATA_TEST_CASE(decimal_literal, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("decimal_literal"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::decimal_literal;
    auto const parser = testsuite::vhdl::parser::decimal_literal();
