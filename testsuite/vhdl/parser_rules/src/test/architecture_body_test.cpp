//
// @file architecture_body_test.cpp
//
...
BOOST_DATA_TEST_CASE(architecture_body, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("architecture_body"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::architecture_body;
    auto const parser = testsuite::vhdl::parser::architecture_body();
