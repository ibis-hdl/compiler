...
BOOST_DATA_TEST_CASE(type_definition, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("type_definition"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::type_definition;
    auto const parser = testsuite::vhdl::parser::type_definition();
