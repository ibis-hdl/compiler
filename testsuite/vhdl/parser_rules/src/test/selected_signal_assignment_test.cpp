//
// @file selected_signal_assignment_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    ...
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("selected_signal_assignment"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::selected_signal_assignment;
    auto const parser = testsuite::vhdl::parser::selected_signal_assignment();
