//
// @file package_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(package_declaration, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("package_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::package_declaration;
    auto const parser = testsuite::vhdl::parser::package_declaration();
