//
// @file range_constraint_test.cpp
//
...
BOOST_DATA_TEST_CASE(range_constraint, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("range_constraint"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::range_constraint;
    auto const parser = testsuite::vhdl::parser::range_constraint();
