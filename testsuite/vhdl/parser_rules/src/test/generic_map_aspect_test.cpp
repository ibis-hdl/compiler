//
// @file generic_map_aspect_test.cpp
//
...
BOOST_DATA_TEST_CASE(generic_map_aspect, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("generic_map_aspect"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::generic_map_aspect;
    auto const parser = testsuite::vhdl::parser::generic_map_aspect();
