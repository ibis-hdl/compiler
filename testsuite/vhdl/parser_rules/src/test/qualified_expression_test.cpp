//
// @file qualified_expression_test.cpp
//
...
BOOST_DATA_TEST_CASE(qualified_expression, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("qualified_expression"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::qualified_expression;
    auto const parser = testsuite::vhdl::parser::qualified_expression();
