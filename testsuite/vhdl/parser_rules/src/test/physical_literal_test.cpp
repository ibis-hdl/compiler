//
// @file physical_literal_test.cpp
//
...
BOOST_DATA_TEST_CASE(physical_literal, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("physical_literal"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::physical_literal;
    auto const parser = testsuite::vhdl::parser::physical_literal();
...
BOOST_DATA_TEST_CASE(physical_literal_failure, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("physical_literal_failure"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::physical_literal;
    auto const parser = testsuite::vhdl::parser::physical_literal();
