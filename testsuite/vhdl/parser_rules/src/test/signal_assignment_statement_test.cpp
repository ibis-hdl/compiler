//
// @file signal_assignment_statement_test.cpp
//
...
BOOST_DATA_TEST_CASE(signal_assignment_statement, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("signal_assignment_statement"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::signal_assignment_statement;
    auto const parser = testsuite::vhdl::parser::signal_assignment_statement();
