...
BOOST_DATA_TEST_CASE(
    port_map_aspect,                                                              // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("port_map_aspect"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::port_map_aspect;
    auto const parser = testsuite::vhdl::parser::port_map_aspect();
