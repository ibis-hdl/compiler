//
// @file sequential_statement_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    ...
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("sequential_statement"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::sequential_statement;
    auto const parser = testsuite::vhdl::parser::sequential_statement();
