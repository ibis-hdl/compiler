//
// @file index_constraint_test.cpp
//
...
BOOST_DATA_TEST_CASE(index_constraint, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("index_constraint"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::index_constraint;
    auto const parser = testsuite::vhdl::parser::index_constraint();
