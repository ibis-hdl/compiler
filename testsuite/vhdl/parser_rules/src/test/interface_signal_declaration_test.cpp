//
// @file interface_signal_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    ...
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("interface_signal_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::interface_signal_declaration;
    auto const parser = testsuite::vhdl::parser::interface_signal_declaration();
