//
// @file variable_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(variable_declaration, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("variable_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::variable_declaration;
    auto const parser = testsuite::vhdl::parser::variable_declaration();
