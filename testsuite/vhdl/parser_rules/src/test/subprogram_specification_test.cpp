//
// @file subprogram_specification_test.cpp
//
...
BOOST_DATA_TEST_CASE(subprogram_specification, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("subprogram_specification"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::subprogram_specification;
    auto const parser = testsuite::vhdl::parser::subprogram_specification();
