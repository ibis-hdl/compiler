//
// @file character_literal_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    character_literal,                                                              // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("character_literal"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::character_literal;
    auto const parser = testsuite::vhdl::parser::character_literal();
