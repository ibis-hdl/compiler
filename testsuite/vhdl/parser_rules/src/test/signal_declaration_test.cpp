//
// @file signal_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    signal_declaration,                                                              // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("signal_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::signal_declaration;
    auto const parser = testsuite::vhdl::parser::signal_declaration();
