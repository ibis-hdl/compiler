//
// @file conditional_signal_assignment_test.cpp
//
...
BOOST_DATA_TEST_CASE(conditional_signal_assignment, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("conditional_signal_assignment"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::conditional_signal_assignment;
    auto const parser = testsuite::vhdl::parser::conditional_signal_assignment();
