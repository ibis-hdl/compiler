//
// @file attribute_specification_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    ...
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("attribute_specification"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::attribute_specification;
    auto const parser = testsuite::vhdl::parser::attribute_specification();
