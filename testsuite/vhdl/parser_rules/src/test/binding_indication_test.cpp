//
// @file binding_indication_test.cpp
//
...
BOOST_DATA_TEST_CASE(binding_indication, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("binding_indication"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::binding_indication;
    auto const parser = testsuite::vhdl::parser::binding_indication();
