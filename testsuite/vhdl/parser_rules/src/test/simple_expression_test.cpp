//
// @file simple_expression_test.cpp
//
...
BOOST_DATA_TEST_CASE(simple_expression, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("simple_expression"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::simple_expression;
    auto const parser = testsuite::vhdl::parser::simple_expression();
