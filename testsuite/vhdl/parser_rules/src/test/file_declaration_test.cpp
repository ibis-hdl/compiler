//
// @file file_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(file_declaration, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("file_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::file_declaration;
    auto const parser = testsuite::vhdl::parser::file_declaration();
