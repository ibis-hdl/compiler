//
// @file bit_string_literal_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    bit_string_literal,                                                              // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("bit_string_literal"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::bit_string_literal;
    auto const parser = testsuite::vhdl::parser::bit_string_literal();
