//
// @file group_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(group_declaration, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("group_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::group_declaration;
    auto const parser = testsuite::vhdl::parser::group_declaration();
