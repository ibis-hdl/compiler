...
BOOST_DATA_TEST_CASE(identifier_list, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("identifier_list"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::identifier_list;
    auto const parser = testsuite::vhdl::parser::identifier_list();
