//
// @file enumeration_type_definition_test.cpp
//
...
BOOST_DATA_TEST_CASE(enumeration_type_definition, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("enumeration_type_definition"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::enumeration_type_definition;
    auto const parser = testsuite::vhdl::parser::enumeration_type_definition();
