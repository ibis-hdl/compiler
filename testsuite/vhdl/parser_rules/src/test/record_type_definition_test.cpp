//
// @file record_type_definition_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    ...
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("record_type_definition"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::record_type_definition;
    auto const parser = testsuite::vhdl::parser::record_type_definition();
