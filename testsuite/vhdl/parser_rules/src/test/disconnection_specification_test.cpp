//
// @file disconnection_specification_test.cpp
//
...
BOOST_DATA_TEST_CASE(disconnection_specification, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("disconnection_specification"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::disconnection_specification;
    auto const parser = testsuite::vhdl::parser::disconnection_specification();
