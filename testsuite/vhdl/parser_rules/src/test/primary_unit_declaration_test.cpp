//
// @file primary_unit_declaration_test.cpp
//
...
BOOST_DATA_TEST_CASE(primary_unit_declaration, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("primary_unit_declaration"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::primary_unit_declaration;
    auto const parser = testsuite::vhdl::parser::primary_unit_declaration();
