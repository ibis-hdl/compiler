//
// @file parameter_specification_test.cpp
//
...
BOOST_DATA_TEST_CASE(
    ...
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("parameter_specification"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::parameter_specification;
    auto const parser = testsuite::vhdl::parser::parameter_specification();
