//
// @file variable_assignment_statement_test.cpp
//
...
BOOST_DATA_TEST_CASE(variable_assignment_statement, // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("variable_assignment_statement"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::variable_assignment_statement;
    auto const parser = testsuite::vhdl::parser::variable_assignment_statement();
