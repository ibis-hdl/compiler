...
BOOST_DATA_TEST_CASE(expression,                                                              // --
                     utf_data::make_delayed<testsuite::vhdl::parser::dataset>("expression"),  // --
                     input, expected, test_case_name)
{
    using attribute_type = ast::expression;
    auto const parser = testsuite::vhdl::parser::expression();
...
BOOST_DATA_TEST_CASE(
    expression_failure,                                                              // --
    utf_data::make_delayed<testsuite::vhdl::parser::dataset>("expression_failure"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::expression;
    auto const parser = testsuite::vhdl::parser::expression();
