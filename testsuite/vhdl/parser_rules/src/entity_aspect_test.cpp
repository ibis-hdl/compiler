...
BOOST_DATA_TEST_CASE_F( testsuite::failure_diagnostic_fixture,
    entity_aspect,
    utf_data::make_delayed<testsuite::dataset_loader>( "test_case/entity_aspect" ),
    input, expected, test_case_name)
{
    using attribute_type = ast::entity_aspect; 
    auto const& parser = testsuite::vhdl_parser::entity_aspect();
