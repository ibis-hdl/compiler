...
BOOST_DATA_TEST_CASE_F(  // --
    testsuite::vhdl_parser::util::failure_diagnostic_fixture, expression,
    utf_data::make_delayed<testsuite::util::dataset_loader>("test_data/expression"),  // --
...
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
BOOST_DATA_TEST_CASE_F(  // --
    testsuite::vhdl_parser::util::failure_diagnostic_fixture, expression_failure,
    utf_data::make_delayed<testsuite::util::dataset_loader>("test_data/expression_failure"),  // --
    input, expected, test_case_name)
{
    using attribute_type = ast::expression;
    auto const& parser = testsuite::vhdl_parser::expression();
