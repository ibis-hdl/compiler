...
class TraceLog {
    /// Friend required for testing copy implementation.
    friend ::testsuite::TraceLogMock;
...
public:
    ...
    public:
        ...
        operator TraceValue() const { return TraceValue(sv); }
    ...
    std::int32_t threshold_begin_id, clock::duration_type threshold)
{
    ...
    return AddTraceEventInternal(          // --
        ...
        trace_id, flags,                   // --
        std::string_view(), TraceValue(),  // -- no argument
