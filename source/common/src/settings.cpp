...
#include <boost/iostreams/stream.hpp>           // [-Wdeprecated-copy]
#include <boost/property_tree/json_parser.hpp>  // [-Wsign-conversion]
#include <boost/property_tree/ptree.hpp>        // [-Wsign-conversion]
