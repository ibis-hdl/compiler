/*
 * concurrent_assertion_statement_parsertest.cpp
 *
...
struct concurrent_assertion_statement_dataset : public ::x3_test::dataset_loader
{
    ...
    VHDL_code, expect_AST, test_case_name)
{
    ...
    auto const parser = parser::concurrent_assertion_statement;
