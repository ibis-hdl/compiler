/*
 * record_type_definition_parsertest.cpp
 *
...
struct record_type_definition_dataset : public ::x3_test::dataset_loader
{
    ...
    input, expected, test_case_name)
{
    ...
    auto const parser = parser::record_type_definition;
