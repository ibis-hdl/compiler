/*
 * secondary_unit_declaration_parsertest.cpp
 *
...
struct secondary_unit_declaration_dataset : public ::x3_test::dataset_loader
{
    ...
    VHDL_code, expect_AST, test_case_name)
{
    ...
    auto const parser = parser::secondary_unit_declaration;
