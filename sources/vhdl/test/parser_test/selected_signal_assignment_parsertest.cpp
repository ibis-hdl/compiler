/*
 * selected_signal_assignment_parsertest.cpp
 *
...
struct selected_signal_assignment_dataset : public ::x3_test::dataset_loader
{
    ...
    input, expected, test_case_name)
{
    ...
    auto const parser = parser::selected_signal_assignment;
